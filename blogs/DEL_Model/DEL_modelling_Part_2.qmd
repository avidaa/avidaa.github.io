...
For a concrete comparison, suppose the baseline, $\mu_{\mathrm{baseline},c}$, is 100 expected reads and use the median of each scale prior, $0.67\tau$, as a representative spread:
