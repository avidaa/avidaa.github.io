...
![DAG showing observed counts, rates, and latent factors.](img/dag-with-latent-factors.png){#fig-dag-latent-factors width="50%"}
...
1. Add the plate for all compounds
2. Add the replicate level variation parameters
