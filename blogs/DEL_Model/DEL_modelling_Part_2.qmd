...
The term $1/\mu$ is the contribution of Poisson counting noise to the squared CV, while $\kappa_c^2$ is the contribution of overdispersion. As $\mu$ increases, $1/\mu$ becomes smaller, so **the total CV approaches $\kappa_c$**.

For example, if the expected count is $1{,}000$ reads:

- if $\kappa_c=0.5$, then
  $\operatorname{CV}=\sqrt{1/1000+(0.5)^2}=\sqrt{0.251}\approx0.501$ and
...
- if $\kappa_c=0.1$, then
  $\operatorname{CV}=\sqrt{1/1000+(0.1)^2}=\sqrt{0.011}\approx0.105$ and
  $\operatorname{SD}=\sqrt{1000+1000^2(0.1)^2}=\sqrt{11{,}000}\approx105$ reads, or about $1{,}000\times0.1=100$ reads.

If the expected count is $0.1$ reads:

- if $\kappa_c=0.5$, then
  $\operatorname{CV}^2=\sqrt{1/0.1+(0.5)^2}=\sqrt{10.25}\approx3.2$ and
  $\operatorname{SD}=\sqrt{0.1+0.1^2(0.5)^2}=\sqrt{0.13}\approx0.36$ reads, compared with about $0.1\times0.5=0.05$ reads using the large-count approximation $\operatorname{SD}\approx\mu\kappa_c$;
- if $\kappa_c=0.1$, then
  $\operatorname{CV}=\sqrt{1/0.1+(0.1)^2}=\sqrt{1.1}\approx1.05$ and
  $\operatorname{SD}=\sqrt{0.1+0.1^2(0.1)^2}=\sqrt{0.11}\approx0.33$ reads, compared with about $0.1\times0.1=0.01$ read.
