...
:::: {#log-scale-effects-and-expected-counts .callout-note collapse="true" icon="false"}
## How log-scale effects change expected counts
...
Using the relationship derived in [How log-scale effects change expected counts](#log-scale-effects-and-expected-counts){.box-ref-highlight}, suppose the baseline, $\mu_{\mathrm{baseline},c}$, is 100 expected reads and use the median of each scale prior, $0.67\tau$, as a representative spread:
