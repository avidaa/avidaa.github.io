...
![Umbrella example DAG.](img/umbrella_dag.png){#fig-umbrella-dag width="50%"}
...
Latent-variable models can make hidden confounding explicit, but they require stronger assumptions. If the hidden variable is not observed, **the model may be weakly identified**, and the posterior can remain highly uncertain. In this example, the latent Weather model is more faithful to the causal DAG, but **less transparent and more assumption-dependent than the sensitivity analysis**.
