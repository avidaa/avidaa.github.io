...
$$
\binom{N}{k}p_i^k = \binom{N}{k}\left(\frac{\lambda_i}{N}\right)^k = \frac{N(N-1)\cdots(N-k+1)}{k!}\frac{\lambda_i^k}{N^k} = \frac{\lambda_i^k}{k!}.\overset{\longrightarrow\,1}{\cancel{\prod_{j=0}^{k-1}\left(1-\overset{\longrightarrow \ 0}{\cancel{\frac{j}{N}}}\right)}}\longrightarrow \frac{\lambda_i^k}{k!}.1 = \frac{\lambda_i^k}{k!}
$$
...
***************
$$
\left(1-\frac{\lambda_i}{N}\right)^{N-k} = \left(1-\frac{\lambda_i}{N}\right)^N
...
$$
\Pr(X_i=k) = e^{-\lambda_i}\frac{\lambda_i^k}{k!}
$$
