...
Let's start by plotting the relationship between pre-selection counts and post-selection counts for the matrix and target selection conditions. 
...
(
    ...
    + gg.theme_bw()
    + gg.theme(figure_size=(13, 4))
)
```

[**Figure 12:** Pairwise relationships between `seq_load`, matrix mean, and target mean counts (log scale).]{.fig-caption}

TODO: 1. Do we need Matrix vs Target here? Or does it need its own section?
2. We need interpretation for the plots
