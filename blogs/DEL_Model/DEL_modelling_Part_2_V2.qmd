...
The compound and replicate effects are not given independent fixed-width priors. Each group shares a population scale, so the amount of variation among compounds or among replicates is learned from the data. We place Half-Normal priors on those scales:
