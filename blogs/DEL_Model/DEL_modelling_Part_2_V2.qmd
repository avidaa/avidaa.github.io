...
We estimate the effects together because each measurement provides only part of the explanation. After accounting for input abundance and sample-level effects, a high target count could reflect greater background retention [$b_i$]{style="color:#88c0d0"}, greater target-specific enrichment [$s_i$]{style="color:#bf616a"}, or both. Matrix measurements help us estimate the background contribution, but they are noisy. Uncertainty about background therefore carries through to our estimate of target-specific enrichment.
