...
Use a Negative Binomial model when the variance increases faster than the mean. In the NB2 parameterisation used throughout this blog, the mean and variance are
