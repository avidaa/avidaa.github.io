...
![Matrix binders. Molecules with high sequencing counts in matrix (control) conditions. These molecules can confound analysis by mimicking protein hits.](img/NTC_Binders.png){#fig-matrix-binders }
...
![Most molecules have very low counts, indicating sparse DEL data.](img/High_Density_Near_Low_Counts.png){#fig-low-count-mass }
...
![Discrete horizontal bands. The plot shows how discrete, integer sequencing counts lead to repeated identical values among molecules, appearing as horizontal bands in the ECDF.](img/Discrete_horizontal_bands.png){#fig-discrete-bands }
...
![Comparing pre- and post-selection counts allows us to account for differences in the original library composition.](img/pre_post_selection_counts.png){#fig-pre-post-overview }
...
![Relationship between matrix and target counts.](img/matrix_vs_target_counts.png){#fig-matrix-target-overview }
...
![Causal sketch of DEL sequencing counts.](img/Causal_Sketch.png){#fig-causal-sketch }
